      ...
      <View style={[styles.bottomBar]}>
        {!isLastStep ? (
          <TouchableOpacity onPress={handleStop}>
            <FlatButton onPress={handleStop} textStyle={styles.buttonText}>
              {labels?.skip || "Skip"}
            </FlatButton>
          </TouchableOpacity>
        ) : null}
        {!isFirstStep ? (
          <TouchableOpacity onPress={handlePrev}>
            <FlatButton onPress={handlePrev} textStyle={styles.buttonText}>
        ...
        {!isLastStep ? (
          <TouchableOpacity onPress={handleNext}>
            <FlatButton onPress={handleNext} textStyle={styles.buttonText}>
              {labels?.next || "Next"}
            </FlatButton>
          </TouchableOpacity>
        ) : (
