const en = {
  ...
  addAnotherBudget: "Add another budget",
  addAnotherBudgetHint: "New budgets start empty",
  yourBudget: "Your budget",
  myBudgetAutoName: "My Budget",
  ...
  premiumStatusManageHint: "Change or cancel in your App Store settings",
  settingsTitle: "Settings",
  restorePurchases: "Restore Purchases",
  deleteAccount: "Delete Account",
  settingsVersionHeader: "Version",
  settingsCurrentVersionLine: "Current version created at: %{createdAt}",
  settingsLatestVersionLine: "Latest version available at: %{createdAt}",
  settingsUpdatesDisabledLabel: "Updates disabled on this build",
  ...
  toastDeletedExpense1: "Expense deleted",
  toastDeletedExpense2: "You can undo this action",
  undo: "Undo",
  toastUndoDeleteExpired: "Undo is no longer available for this delete.",
  ...
  enableNotificationsSettings: "Please enable notifications in settings!",
...
const de = {
  ...
  addAnotherBudget: "Weiteres Budget hinzufügen",
  addAnotherBudgetHint: "Neue Budgets starten leer",
  yourBudget: "Dein Budget",
  myBudgetAutoName: "Mein Budget",
  ...
  premiumStatusManageHint: "Im App Store ändern oder kündigen",
  settingsTitle: "Einstellungen",
  restorePurchases: "Käufe wiederherstellen",
  deleteAccount: "Account löschen",
  settingsVersionHeader: "Version",
  settingsCurrentVersionLine: "Aktuelle Version erstellt am: %{createdAt}",
  settingsLatestVersionLine: "Neueste Version verfügbar ab: %{createdAt}",
  settingsUpdatesDisabledLabel: "Updates sind in diesem Build deaktiviert",
  ...
  toastDeletedExpense1: "Ausgabe gelöscht",
  toastDeletedExpense2: "Du kannst diese Aktion rückgängig machen",
  undo: "Rückgängig",
  toastUndoDeleteExpired:
    "Rückgängig machen ist für diese Löschung nicht mehr möglich.",
  ...
  gptInfoText:
    'Wenn du die Funktion "Lokale Preise Anzeigen" nutzt, führt unsere KI Echtzeit-Websuchen durch, um aktuelle lokale Preise und saisonale Daten für deinen spezifischen Standort und dein Produkt zu finden. GPT-4.1 analysiert deine Kosten mit aktuellen Marktinformationen, saisonalen Trends und aktuellen Preisdaten aus mehreren Quellen. Das System sucht sowohl nach aktuellen Marktpreisen als auch nach saisonalen Faktoren, die die Preise in deiner Region beeinflussen. Denk daran, dass GPT-4.1 eine leistungsstarke KI mit Zugang zu aktuellen Daten ist, aber kein zertifizierter Finanzexperte. Verwende seine Bewertung als Referenz, nicht als professionellen Rat. Um genaue Bewertungen zu erhalten, solltest du so viele relevante Informationen wie möglich in deine Ausgabenbeschreibung aufnehmen. Dein Feedback ist wertvoll, um die Genauigkeit und Nützlichkeit des Systems zu verbessern.',
  owes: "schuldet",
  ...
  unsavedChangesMessage:
    "Sie haben ungespeicherte Änderungen. Möchten Sie sie wiederherstellen?",
  discard: "Löschen",
  restore: "Wiederherstellen",
  unsavedItems: "Ungespeicherte Elemente",
  amount: "Betrag",
  description: "Beschreibung",
  category: "Kategorie",
  country: "Land",
  currency: "Währung",
  splitType: "Aufteilungstyp",
  equal: "Gleichmäßig",
  exact: "Exakt",
  ...
  latestPurchaseDate: "Letztes Kaufdatum:",
  periodType: "Periodentyp:",
  willRenew: "Wird verlängert:",
  store: "Store:",
...
const fr = {
  ...
  addAnotherBudget: "Ajouter un autre budget",
  addAnotherBudgetHint: "Les nouveaux budgets commencent vides",
  yourBudget: "Votre budget",
  myBudgetAutoName: "Mon budget",
  ...
  premiumStatusManageHint: "Modifier ou annuler dans l'App Store",
  settingsTitle: "Paramètres",
  restorePurchases: "Restaurer les achats",
  deleteAccount: "Supprimer le compte",
  settingsVersionHeader: "Version",
  settingsCurrentVersionLine: "Version actuelle créée le : %{createdAt}",
  settingsLatestVersionLine: "Dernière version disponible le : %{createdAt}",
  settingsUpdatesDisabledLabel: "Mises à jour désactivées sur ce build",
  ...
  toastDeletedExpense1: "Dépense supprimée",
  toastDeletedExpense2: "Vous pouvez annuler cette action",
  undo: "Annuler",
  toastUndoDeleteExpired:
    "L'annulation n'est plus disponible pour cette suppression.",
  ...
  gptInfoText:
    "Si tu utilises la fonction \"Obtenir le Prix Local\", notre IA effectue des recherches web en temps réel pour trouver les prix locaux actuels et les données saisonnières pour votre emplacement et produit spécifiques. GPT-4.1 analyse vos coûts en utilisant des informations de marché à jour, des tendances saisonnières et des données de prix actuelles provenant de plusieurs sources. Le système recherche à la fois les prix de marché actuels et les facteurs saisonniers qui affectent les prix dans votre région. N'oublie pas que GPT-4.1 est une IA puissante avec accès aux données actuelles, mais ce n'est pas un expert financier certifié. Utilise son évaluation comme référence, pas comme un conseil professionnel. Pour obtenir des évaluations précises, tu dois inclure autant d'informations pertinentes que possible dans la description de tes dépenses. Ton feedback est précieux pour améliorer la précision et l'utilité du système",
  owes: "doit à",
  ...
  unsavedChangesMessage:
    "Vous avez des modifications non sauvegardées. Souhaitez-vous les restaurer?",
  discard: "Supprimer",
  restore: "Restaurer",
  unsavedItems: "Éléments non sauvegardés",
  amount: "Montant",
  description: "Description",
  category: "Catégorie",
  country: "Pays",
  ...
  latestPurchaseDate: "Date du dernier achat:",
  periodType: "Type de période:",
  willRenew: "Se renouvellera:",
  store: "Magasin:",
...
const ru = {
  ...
  addAnotherBudget: "Добавить другой бюджет",
  addAnotherBudgetHint: "Новые бюджеты начинаются пустыми",
  yourBudget: "Ваш бюджет",
  myBudgetAutoName: "Мой бюджет",
  ...
  premiumStatusManageHint: "Изменить или отменить в App Store",
  settingsTitle: "Настройки",
  restorePurchases: "Восстановить покупки",
  deleteAccount: "Удалить аккаунт",
  settingsVersionHeader: "Версия",
  settingsCurrentVersionLine: "Текущая версия создана: %{createdAt}",
  settingsLatestVersionLine: "Последняя версия доступна: %{createdAt}",
  settingsUpdatesDisabledLabel: "Обновления отключены в этом билде",
  ...
  toastDeletedExpense1: "Расход удалён",
  toastDeletedExpense2: "Вы можете отменить это действие",
  undo: "Отменить",
  toastUndoDeleteExpired:
    "Отмена для этого удаления больше недоступна.",
  ...
  gptInfoText:
    'Когда вы используете функцию "Получить Местную Цену", наш ИИ выполняет поиск в интернете в реальном времени, чтобы найти актуальные местные цены и сезонные данные для вашего конкретного местоположения и продукта. GPT-4.1 анализирует ваши расходы, используя актуальную рыночную информацию, сезонные тенденции и текущие данные о ценах из множества источников. Система ищет как текущие рыночные цены, так и сезонные факторы, которые влияют на цены в вашем регионе. Помните, что GPT-4.1 - это мощный ИИ с доступом к актуальным данным, но не сертифицированный финансовый эксперт. Используйте его оценку как справочник, а не как профессиональный совет. Чтобы получить точные рейтинги, вы должны включить как можно больше релевантной информации в описание ваших расходов. Ваши отзывы ценны для повышения точности и полезности системы',
  owes: "должен",
  ...
  unsavedChangesMessage:
    "У вас есть несохраненные изменения. Хотите ли вы их восстановить?",
  discard: "Удалить",
  restore: "Восстановить",
  unsavedItems: "Несохраненные элементы",
  amount: "Сумма",
  ...
  latestPurchaseDate: "Дата последней покупки:",
  periodType: "Тип периода:",
  willRenew: "Будет продлена:",
  store: "Магазин:",
  ...
  enableNotificationsSettings: "Пожалуйста, включите уведомления в настройках!",
