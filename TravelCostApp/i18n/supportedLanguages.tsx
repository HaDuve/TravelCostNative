const en = {
  ...
  showBudgetLine: "Show Budget Line",
...
const de = {
  ...
  showBudgetLine: "Budgetlinie anzeigen",
  showBarLabels: "Balkenbeschriftungen anzeigen",
...
const fr = {
  ...
  showBudgetLine: "Afficher la ligne de budget",
  showBarLabels: "Afficher les étiquettes des barres",
...
const ru = {
  ...
  showBudgetLine: "Показать линию бюджета",
  showBarLabels: "Показать подписи столбцов",
