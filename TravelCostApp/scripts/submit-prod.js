...
const CONFIG = {
  android: {
    ...
    serviceAccountKey: process.env.GOOGLE_PLAY_SERVICE_ACCOUNT_KEY || '/Users/hiono/Documents/Keys/Budget_For_Nomads/EAS/Google_Play_Console/budget-for-nomads-468110-5964d3e3e268.json',
...
function checkPrerequisites() {
  ...
  if (!fs.existsSync(CONFIG.android.serviceAccountKey)) {
    log(`Google Play service account key not found at: ${CONFIG.android.serviceAccountKey}`, 'red');
    log('Please ensure the service account key file exists and is accessible', 'yellow');
    process.exit(1);
  }
